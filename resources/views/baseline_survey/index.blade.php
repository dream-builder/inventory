...
@section('content')
        ...
        <div class="row" style="margin-top: 15px;">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <div class="box-header">
                        <h3 class="box-title">Baseline Survey List</h3>
                    </div>
    ...
    <script>
        function get_list() {
            ...
            $.ajax({
                type: "GET",
                url: site_url + "/baseline_survey/list",
                // data: data,
                cache: false,
        ...
        function resigter_assignment() {
            ...
            $.ajax({
                type: "GET",
                url: site_url + "/baseline_survey/register",
                data: data,
                cache: false,
                success: function(return_data) {
                    ...
                    if (return_data == 'Already assigned') {
                        ...
                        swal("Baseline Assignment", "Already assigned.", "warning");

                    }

                    if (return_data == 'success') {
                        swal("Baseline Assignment", "Assigned Successfully", "success");
                        get_list();
                    }

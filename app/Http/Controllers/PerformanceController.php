...
class DashboardController extends Controller
{
    ...
    public function index() {
       ...
       if(isset($_GET['region']) && $_GET['region'] !=""){
        ...
        return view('reports/facilities_view',['facilities'=>$data,'facility_type'=>$facility_type]);
    }
    ...
    private function facility_performance(){
        ...
        //Month 1
        $result = DB::select(inner('2021-09-01','2021-09-30' ));
        ...
        //Month 2
        $result = DB::select(inner('2021-09-01','2021-10-31' ));
        ...
        //Month 3
        $result = DB::select(inner('2021-09-01','2021-11-30' ));
    ...
    public function issue_search(){
       ...
       if(isset($_GET['start_date']) && $_GET['start_date']!="" && isset($_GET['end_date']) && $_GET['end_date']!=""){
           $sql .= " and i.create_date::date between '".$_GET['start_date']."' and '".$_GET['end_date']."'";
       }
